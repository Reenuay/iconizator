<template>
    <div>
        ...
        <b-container class="my-3" fluid>
                ...
                <b-col md="8" offset-md="2">
                    <b-form-group label="Icons Folder Path:"
                        ...
                        <div>
                            ...
                            <b-btn @click="openDialog('cleanserIconsFolder', 'folder')"
                                class="ml-3 float-right">
                                Browse
                            </b-btn>
                        </div>
            ...
            <b-row>
                <b-col md="8" offset-md="2">
                    <b-form-group label="Words to cleanse:"
                        label-cols="2"
                        breakpoint="md"
                        horizontal>
                        <b-form-textarea placeholder="Words to cleanse"
                            v-model="wordsToCleanse"
                            @input="wordsToCleanseChanged()"
                            rows="6"
                            max-rows="6">
                        </b-form-textarea>
                    </b-form-group>
            ...
            <b-row>
                <b-col md="8" offset-md="2" class="mb-3">
                    <b-form-checkbox v-model="cleanseTitle"
                     :value="true"
                     :unchecked-value="false">
                        Cleanse title
                    </b-form-checkbox>
            ...
            <b-row>
                <b-col md="8" offset-md="2" class="text-center mb-3">
                    <b-btn :disabled="!cleanserIsReady"
                        :variant="cleanserIsProcessing ? 'danger' : 'primary'"
                        @click="switchCleansing()"
                        class="float-right">
                        {{cleanserIsProcessing ? 'Stop' : 'Start'}}
                    </b-btn>
                </b-col>
            </b-row>
            <b-row v-if="cleanserIsProcessing">
                <b-col md="8" offset-md="2">
                    <b-progress :max="cleanserMaxProgress"
                        animated
                        striped>
                        <b-progress-bar :value="cleanserMaxProgress"
                            variant="danger"
                            :label="
                                cleanserMaxProgress > 0 && cleanserProgress > 0
                                    ? cleanserProgress + '/' + cleanserMaxProgress
                                    : ''
                            ">
                        </b-progress-bar>
                    </b-progress>
